...
import JensoncollinsLoanJensoncollinsLoanLoan from './jensoncollins/loan/jensoncollins.loan.loan'
...
export default { 
  ...
  JensoncollinsLoanJensoncollinsLoanLoan: load(JensoncollinsLoanJensoncollinsLoanLoan, 'jensoncollins.loan.loan'),
