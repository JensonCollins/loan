...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/jensoncollins/loan/loan/loan
   */
  queryLoanAll = (
    query?: {
    ...
    this.request<LoanQueryAllLoanResponse, RpcStatus>({
      path: `/jensoncollins/loan/loan/loan`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/jensoncollins/loan/loan/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LoanQueryParamsResponse, RpcStatus>({
      path: `/jensoncollins/loan/loan/params`,
      method: "GET",
      format: "json",
      ...params,
    });
